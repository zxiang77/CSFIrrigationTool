...
var ANIMATION_PROPTYPES = _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.shape({
  stiffness: _react.PropTypes.number,
  damping: _react.PropTypes.number
}), _react.PropTypes.bool]);

var propTypes = {
  animatedProps: _react.PropTypes.arrayOf(_react.PropTypes.string).isRequired,
